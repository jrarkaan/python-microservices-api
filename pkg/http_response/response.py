...
def success_response(response_data: Optional[Any] = None) -> JSONResponse:
    """
    Returns a JSON http_response with the given status code and the given data.
    :param response_data: The data to be returned.
    :return: A JSON http_response with the given status code and the given data.
    """
...
def error_response(
    ...
    """
    Returns a JSON http_response with the given status code and the given errors.
    :param errors: The errors to be returned.
    :param status_code: The status code of the http_response.
    :return: A JSON http_response with the given status code and the given errors.
    """
